      ...
      <div className="max-w-7xl mx-auto">
          ...
          {showFilters && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              ...
              <select
                ...
                className="w-full lg:w-1/2 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              >
        ...
        <div className="mt-12 text-center text-gray-500">
          <p className="text-sm">
            ...
            multiple agencies. Click "View Source" to access the official
            regulations.
          </p>
        </div>
      </div>
